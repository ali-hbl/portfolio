    ...
    <html lang="fr" className="!scroll-smooth">
      ...
      >
        ...
        >
          ...
          <div className="absolute left-[-35rem] top-[-1rem] h-[31.25rem] w-[50rem] transform-gpu rounded-full bg-[#dbd7fb] blur-[10rem] will-change-transform [backface-visibility:hidden] dark:bg-[#676394] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]" />
        </div>
