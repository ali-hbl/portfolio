  ...
  return (
    <html lang="fr" className="!scroll-smooth">
      ...
      >
        ...
        >
          <div className="absolute right-[11rem] top-[-6rem] h-[31.25rem] w-[31.25rem] transform-gpu rounded-full bg-[#fbe2e3] blur-[8rem] will-change-transform [backface-visibility:hidden] dark:bg-[#946263] sm:w-[68.75rem] sm:blur-[10rem]" />
          <div className="absolute left-[-35rem] top-[-1rem] h-[31.25rem] w-[50rem] transform-gpu rounded-full bg-[#dbd7fb] blur-[8rem] will-change-transform [backface-visibility:hidden] dark:bg-[#676394] sm:w-[68.75rem] sm:blur-[10rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]" />
        </div>
